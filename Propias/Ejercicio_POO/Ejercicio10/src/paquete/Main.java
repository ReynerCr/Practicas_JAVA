        ...
        do {
             ...
             switch (aux) {
                 case 1:
                     ...
                     System.out.println("Nombre: "); nombre = entrada.next();
                     System.out.println("Apellido: "); apellido = entrada.next();
                     System.out.println("Dorsal: "); dorsal = entrada.nextInt();
                     System.out.println("Posicion: "); posicion = entrada.nextInt();
                     System.out.println("Edad: "); edad = entrada.nextInt();
                 ...
                 case 2:
                     ...
                     System.out.println("Apellido: "); apellido = entrada.next();
                     System.out.println("Edad: "); edad = entrada.nextInt();
                     System.out.println("Estrategia: "); estrategia = entrada.next();
                 ...
                 case 3:
                     ...
                     System.out.println("Apellido: "); apellido = entrada.next();
                     System.out.println("Edad: "); edad = entrada.nextInt();
                     System.out.println("Años de experiencia: "); añosExperiencia = entrada.nextInt();
                     System.out.println("Titulacion: "); titulacion = entrada.next();
                     
                     Doctor doctor = new Doctor(titulacion, añosExperiencia, nombre, apellido, edad);
                 	equipo.add(doctor);
                     break;
